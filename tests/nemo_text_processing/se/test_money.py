...
class TestMoney:
    graph = MoneyFst(CardinalFst(deterministic=True), deterministic=True).graph

    @parameterized.expand(parse_test_case_file('se/data_text_normalization/test_cases_money.txt'))
