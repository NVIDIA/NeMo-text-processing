...
testTNCardinal() {
  input=$PROJECT_DIR/ar/data_text_normalization/test_cases_cardinal.txt
  runtest $input
}

testTNDecimal() {
  input=$PROJECT_DIR/ar/data_text_normalization/test_cases_decimal.txt
  runtest $input
}

testTNFraction() {
  input=$PROJECT_DIR/ar/data_text_normalization/test_cases_fraction.txt
  runtest $input
}

testTNMoney() {
  input=$PROJECT_DIR/ar/data_text_normalization/test_cases_money.txt
  runtest $input
}


testTNMeasure() {
  input=$PROJECT_DIR/ar/data_text_normalization/test_cases_measure.txt
  runtest $input
}
