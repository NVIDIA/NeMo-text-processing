...
class TestDate:
    ...
    @parameterized.expand(parse_test_case_file('ar/data_text_normalization/test_cases_date.txt'))
    ...
    @parameterized.expand(parse_test_case_file('ar/data_inverse_text_normalization/test_cases_date.txt'))
    @pytest.mark.run_only_on('CPU')
    @pytest.mark.unit
