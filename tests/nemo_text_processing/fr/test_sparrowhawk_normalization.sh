...
# testTNElectronic() {
#   input=$PROJECT_DIR/fr/data_text_normalization/test_cases_electronic.txt
#   runtest $input
# }
...
# testTNMoney() {
#   input=$PROJECT_DIR/fr/data_text_normalization/test_cases_money.txt
#   runtest $input
# }
...
# testTNTime() {
#   input=$PROJECT_DIR/fr/data_text_normalization/test_cases_time.txt
#   runtest $input
# }

# testTNMeasure() {
#   input=$PROJECT_DIR/fr/data_text_normalization/test_cases_measure.txt
#   runtest $input
# }
