...
class TestPunctuation:
    ...
    @parameterized.expand(parse_test_case_file('te/data_text_normalization/test_cases_punctuation.txt'))
    ...
    @parameterized.expand(parse_test_case_file('te/data_text_normalization/test_cases_punctuation_match_input.txt'))
    @pytest.mark.run_only_on('CPU')
    @pytest.mark.unit
