...
class TestTime:
    ...
    @parameterized.expand(parse_test_case_file('hy/data_inverse_text_normalization/test_cases_time.txt'))
    ...
    @parameterized.expand(parse_test_case_file('hy/data_text_normalization/test_cases_time.txt'))
    @pytest.mark.run_only_on('CPU')
    @pytest.mark.unit
