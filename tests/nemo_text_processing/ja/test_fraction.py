...
class TestFraction:
    ...
    @parameterized.expand(parse_test_case_file('ja/data_text_normalization/test_cases_fraction.txt'))
    ...
    @pytest.mark.run_only_on('CPU')
    @pytest.mark.unit
    def test_norm_fraction_project_input(self, test_input, expected):
    ...
    @pytest.mark.run_only_on('CPU')
    @pytest.mark.unit
    def test_denorm_fraction(self, test_input, expected):
    ...
    @pytest.mark.run_only_on('CPU')
    @pytest.mark.unit
    def test_denorm_fraction_project_input(self, test_input, expected):
