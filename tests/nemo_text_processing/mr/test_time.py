...
class TestTime:
    ...
    inverse_normalizer_project = InverseNormalizer(
        lang='mr', project_input=True, cache_dir=CACHE_DIR, overwrite_cache=False
    )

    @parameterized.expand(parse_test_case_file('mr/data_inverse_text_normalization/test_cases_time.txt'))
