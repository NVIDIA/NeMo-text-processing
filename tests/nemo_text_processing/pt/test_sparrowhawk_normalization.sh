...
testTNCardinal() {
  input=$PROJECT_DIR/pt/data_text_normalization/test_cases_cardinal.txt
  runtest $input
}

testTNDecimal() {
  input=$PROJECT_DIR/pt/data_text_normalization/test_cases_decimal.txt
  runtest $input
}

testTNOrdinal() {
  input=$PROJECT_DIR/pt/data_text_normalization/test_cases_ordinal.txt
  runtest $input
}

testTNFraction() {
 input=$PROJECT_DIR/pt/data_text_normalization/test_cases_fraction.txt
 runtest $input
}

testTNDate() {
  input=$PROJECT_DIR/pt/data_text_normalization/test_cases_date.txt
  runtest $input
}

testTNTime() {
  input=$PROJECT_DIR/pt/data_text_normalization/test_cases_time.txt
  runtest $input
}
