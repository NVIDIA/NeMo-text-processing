      ...
      parallel {
        stage('L2: Eng TN') {
          steps {
            ...
            cd tools/text_processing_deployment && python pynini_export.py --output=$NORM_OUTPUT_DIR --grammars=tn_grammars --cache_dir /home/jenkinsci/TestData/text_norm/ci/grammars/02-01-23-2 --language=en && ls -R $NORM_OUTPUT_DIR && echo ".far files created "|| exit 1'
        ...
        stage('L2: Eng ITN export') {
          steps {
            ...
            cd tools/text_processing_deployment && python pynini_export.py --output=$DENORM_OUTPUT_DIR --grammars=itn_grammars --cache_dir /home/jenkinsci/TestData/text_norm/ci/grammars/02-01-23-2 --language=en && ls -R $DENORM_OUTPUT_DIR && echo ".far files created "|| exit 1'
