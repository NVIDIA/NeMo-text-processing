...
from nemo_text_processing.inverse_text_normalization.hy.verbalizers.verbalize import VerbalizeFst
from nemo_text_processing.inverse_text_normalization.hy.verbalizers.word import WordFst
...
class VerbalizeFinalFst(GraphFst):
    ...
    def __init__(
        ...
        super().__init__(
            name="verbalize_final", kind="verbalize", deterministic=deterministic, project_input=project_input
        )
