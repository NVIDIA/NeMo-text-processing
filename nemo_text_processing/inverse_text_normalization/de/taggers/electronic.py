...
#         )
#         graph = (
#             username + delete_extra_space + pynutil.delete("affenklammer") + insert_space + delete_extra_space + domain_graph
#         )

#         ############# url ###
#         protocol_end = pynini.cross(pynini.union("www", "w w w", "ve ve ve"), "www")
#         protocol_start = pynini.cross(pynini.union("http", "h t t p", "ha te te pe"), "http")
#         protocol_start |= pynini.cross(pynini.union("https", "h t t p s", "ha te te pe es"), "https")
