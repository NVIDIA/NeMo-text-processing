...
# Copyright 2013 and onwards Google, Inc.
#
...
from nemo_text_processing.inverse_text_normalization.kn.utils import get_abs_path, load_labels

NEMO_CHAR = utf8.VALID_UTF8_CHAR

graph_digit = pynini.string_file(get_abs_path("data/numbers/digit.tsv"))

NEMO_KN_DIGIT = pynini.union("೦", "೧", "೨", "೩", "೪", "೫", "೬", "೭", "೮", "೯")
