...
class OrdinalFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        graph = pynini.compose(graph | graph_fem, (cardinal_graph + pynini.union(pynini.cross("वाँ", "वाँ"), pynini.cross("वां","वां"), pynini.cross("वें", "वें"), pynini.cross("वीं", "वीं"), pynini.cross("वी", "वी"), pynini.cross("वें", "वें"), pynini.cross("वे", "वे") ))).optimize()
