...
class TelephoneFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        mobile_keywords = pynini.compose(pynini.cross("mobile", ""), context_cues).project("output").optimize()

        landline_keywords = pynini.compose(pynini.cross("landline", ""), context_cues).project("output").optimize()

        pincode_keywords = pynini.compose(pynini.cross("pincode", ""), context_cues).project("output").optimize()

        credit_keywords = pynini.compose(pynini.cross("credit", ""), context_cues).project("output").optimize()
