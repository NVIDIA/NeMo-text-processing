...
class CardinalFst(GraphFst):
    ...
    def __init__(self, input_case: str = INPUT_LOWER_CASED):
        ...
        graph_hundred_as_thousand = graph_teens_and_ties + delete_space + graph_hundred
        graph_hundred_as_thousand += delete_space + self.graph_two_digit
        ...
        graph_in_crores = pynini.union(
            self.graph_two_digit
            + delete_space
            + pynutil.delete("करोड़") | pynutil.delete("crores"),
            pynutil.insert("००", weight=0.1),
        )
        ...
        graph = pynini.union(graph_ind + delete_space + graph_hundreds, graph_zero, )
