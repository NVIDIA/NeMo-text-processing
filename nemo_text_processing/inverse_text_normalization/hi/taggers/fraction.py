...
class FractionFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        graph_paune_only = pynini.union(pynutil.delete("पौन") | pynutil.delete("पौना")) + delete_space + pynutil.insert("numerator: \"३\"") + delete_space + pynutil.insert(" denominator: \"४\"")
        
        graph_tihaai = numerator + delete_space + pynutil.delete("तिहाई") + delete_space + pynutil.insert(" denominator: \"३\"")
        graph_chauthaai = numerator + delete_space + pynutil.delete("चौथाई") + delete_space + pynutil.insert(" denominator: \"४\"")
        
        graph_quarterly_exceptions = graph_saade | graph_sava | graph_paune | graph_dedh | graph_dhaai | graph_aadha_and_saade_only | graph_sava_only | graph_paune_only | graph_tihaai | graph_chauthaai
