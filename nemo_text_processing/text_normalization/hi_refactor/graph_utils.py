...
import pynini
from nemo_text_processing.text_normalization.hi_refactor.utils import get_abs_path, load_labels
...
NEMO_HI_WO = pynini.union("शून्य","एक","दो", "तीन", "चार", "पाँच", "छे", "सात", "आठ", "नौ").optimize()
