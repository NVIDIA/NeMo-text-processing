...
from nemo_text_processing.text_normalization.ga.graph_utils import LOWER_LENITION_NO_F_NO_S, ensure_space
...
class FractionFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, ordinal: GraphFst, deterministic: bool = True):
        ...
        graph_tens_sg = pynini.union("0" + digit_sg, tens_sg, teen_sg,)
        graph_tens_pl = pynini.union("0" + digit_pl, tens_pl, teen_pl,)
        ...
        numerator_2to10 = pynini.union("0" + (NEMO_DIGIT - "0" - "1"), "10",)
        denominator_2to19 = pynini.union("0" + (NEMO_DIGIT - "0" - "1"), "1" + NEMO_DIGIT,)
