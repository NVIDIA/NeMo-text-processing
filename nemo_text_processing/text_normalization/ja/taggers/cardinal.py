...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        magnitudes = dict(load_labels(get_abs_path("data/numbers/magnitude.tsv")))
        hundred = magnitudes["hundred"]
        thousand = magnitudes["thousand"]
        ten_thousand = magnitudes["ten_thousand"]
        hundred_million = magnitudes["hundred_million"]

        graph_all = (graph_ties + (graph_digit | pynutil.delete("0"))) | graph_teen | graph_digit

        hundreds = NEMO_DIGIT**3
        graph_hundred_component = (
            pynini.cross("1", hundred) | (graph_digit_alt + pynutil.insert(hundred))
        ) + pynini.union(
        ...
        graph_thousand_component = (
            pynini.cross("1", thousand) | (graph_digit_alt + pynutil.insert(thousand))
        ) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_hundred_component,
            (pynini.closure(pynutil.delete("0")) + graph_all),
        )
        graph_thousand_component_alt = (graph_digit + pynutil.insert(thousand)) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_hundred_component,
            (pynini.closure(pynutil.delete("0")) + graph_all),
        )
        ...
        graph_ten_thousand_component = (graph_digit + pynutil.insert(ten_thousand)) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_thousand_component,
        ...
        graph_hundred_thousand_component = (hundred_thousands_position + pynutil.insert(ten_thousand)) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_thousand_component,
            (pynutil.delete("0") + graph_hundred_component),
            (pynini.closure(pynutil.delete("0")) + graph_all),
        ...
        graph_million_component = (million_position + pynutil.insert(ten_thousand)) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_thousand_component,
            (pynutil.delete("0") + graph_hundred_component),
            (pynini.closure(pynutil.delete("0")) + graph_all),
        ...
        graph_ten_million_component = (ten_million_position + pynutil.insert(ten_thousand)) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_thousand_component,
            (pynutil.delete("0") + graph_hundred_component),
            (pynini.closure(pynutil.delete("0")) + graph_all),
        ...
        graph_hundred_million_component = (graph_digit + pynutil.insert(hundred_million)) + pynini.union(
            pynini.closure(pynutil.delete("0")),
        ...
        graph_thousand_million_component = (
            thousand_millions_position + pynutil.insert(hundred_million)
        ) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_ten_million_component,
            (pynutil.delete("0") + graph_million_component),
        ...
        graph_ten_billions_component = (ten_billions_position + pynutil.insert(hundred_million)) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_ten_million_component,
            (pynutil.delete("0") + graph_million_component),
            (pynutil.delete("00") + graph_hundred_thousand_component),
        ...
        graph_hundred_billions_component = (
            hundred_billions_position + pynutil.insert(hundred_million)
        ) + pynini.union(
            pynini.closure(pynutil.delete("0")),
            graph_ten_million_component,
            (pynutil.delete("0") + graph_million_component),
