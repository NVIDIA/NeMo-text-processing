...
class CardinalFst(GraphFst):
    ...
    def __init__(self,deterministic: bool = True):
        ...
        graph_hundred_component = (pynini.cross('1', '百') | (graph_digit_alt + pynutil.insert('百'))) + pynini.union(pynini.closure(pynutil.delete('0')), (pynini.closure(pynutil.delete('0')) + graph_all))
        graph_hundred = hundreds @ graph_hundred_component

        thousands = NEMO_DIGIT**4
        graph_thousand_component = (pynini.cross('1', '千') | (graph_digit_alt + pynutil.insert('千'))) + pynini.union(pynini.closure(pynutil.delete('0')), graph_hundred_component, (pynini.closure(pynutil.delete('0')) + graph_all))
        graph_thousand_component_alt =  (graph_digit+ pynutil.insert('千')) + pynini.union(pynini.closure(pynutil.delete('0')), graph_hundred_component, (pynini.closure(pynutil.delete('0')) + graph_all))
        ...
        graph_hundred_thousand_component = (hundred_thousands_position + pynutil.insert('万')) + pynini.union(pynini.closure(pynutil.delete('0')), graph_thousand_component,(pynutil.delete('0') + graph_hundred_component),(pynini.closure(pynutil.delete('0')) + graph_all))
        ...
        graph_million_component = (million_position + pynutil.insert('万')) + pynini.union(pynini.closure(pynutil.delete('0')), graph_thousand_component,(pynutil.delete('0') + graph_hundred_component),(pynini.closure(pynutil.delete('0')) + graph_all))
        ...
        graph_ten_million_component = (ten_million_position + pynutil.insert('万')) + pynini.union(pynini.closure(pynutil.delete('0')), graph_thousand_component,(pynutil.delete('0') + graph_hundred_component),(pynini.closure(pynutil.delete('0')) + graph_all))
        ...
        graph_thousand_million_component = (thousand_millions_position + pynutil.insert('億')) + pynini.union(pynini.closure(pynutil.delete('0')), graph_ten_million_component,(pynutil.delete('0') +graph_million_component),(pynutil.delete('00')+graph_hundred_thousand_component),(pynutil.delete('000')+graph_ten_thousand_component),(pynutil.delete('0000')+graph_thousand_component),((pynutil.delete('00000')+graph_hundred_component)),(pynini.closure(pynutil.delete('0')) + graph_all))
