...
from nemo_text_processing.text_normalization.te.verbalizers.verbalize import VerbalizeFst
from nemo_text_processing.text_normalization.te.verbalizers.word import WordFst
...
class VerbalizeFinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, cache_dir: str = None, overwrite_cache: bool = False):
        ...
        if cache_dir is not None and cache_dir != "None":
            ...
            far_file = os.path.join(cache_dir, f"te_tn_{deterministic}_deterministic_verbalizer.far")
