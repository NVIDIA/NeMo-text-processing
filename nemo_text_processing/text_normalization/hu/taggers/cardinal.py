...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph_million = make_million(
            "millió", hundreds_for_millions, deterministic
        )
        graph_milliard = make_million(
            "milliárd", hundreds_for_millions, deterministic
        )
        graph_billion = make_million(
            "billió", hundreds_for_millions, deterministic
        )
        graph_billiard = make_million(
            "billiárd", hundreds_for_millions, deterministic
        )
        graph_trillion = make_million(
            "trillió", hundreds_for_millions, deterministic
        )
        graph_trilliard = make_million(
            "trilliárd", hundreds_for_millions, deterministic
        )
