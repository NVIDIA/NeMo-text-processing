...
class MeasureFst(GraphFst):
    ...
    def __init__(
        ...
        subgraph_cardinal = self._create_measure_subgraph("cardinal", cardinal_number_graph, optional_graph_negative, graph_unit)
        subgraph_decimal = self._create_measure_subgraph("decimal", decimal.final_graph_wo_negative, optional_graph_negative, graph_unit)
        subgraph_fraction = self._create_measure_subgraph("fraction", fraction.final_graph_wo_negative, optional_graph_negative, graph_unit)
