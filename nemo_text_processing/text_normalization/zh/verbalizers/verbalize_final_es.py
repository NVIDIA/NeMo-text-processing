...
from nemo_text_processing.text_normalization.zh.verbalizers.verbalize import VerbalizeFst  # this may ne to change
...
class VerbalizeFinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, cache_dir: str = None, overwrite_cache: bool = False):
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            # graph = delete_space + pynini.closure(delete_space + graph + delete_extra_space) + graph + delete_space
