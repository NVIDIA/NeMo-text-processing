...
class Normalizer:
    ...
    def __init__(
        ...
        if lang == "en":
            ...
            from nemo_text_processing.text_normalization.he.taggers.tokenize_and_classify import ClassifyFst
            from nemo_text_processing.text_normalization.he.verbalizers.verbalize_final import VerbalizeFinalFst
        else:
