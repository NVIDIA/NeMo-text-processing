...
composite_graph = graph_digit | graph_zero | graph_teens_and_ties | graph_hundred | graph_thousands | graph_ten_thousands | graph_lakhs | graph_ten_lakhs | graph_crores | graph_ten_crores | graph_arabs | graph_ten_arabs | graph_kharabs | graph_ten_kharabs | graph_nils | graph_ten_nils | graph_padmas | graph_ten_padmas | graph_shankhs | graph_ten_shankhs 

input_text = "१११११११११११११११११११"                                                                                              
output = rewrite.top_rewrite(input_text, composite_graph)           # rewrite.rewrites - to see all possible outcomes , rewrite.top_rewrite - shortest pa
print(output)
