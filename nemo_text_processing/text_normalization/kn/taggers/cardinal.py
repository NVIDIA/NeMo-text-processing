...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph_without_leading_zeros = pynini.union(
            digit, zero, teens_and_ties,
            graph_hundreds, graph_thousands, graph_ten_thousands,
            graph_lakhs, graph_ten_lakhs,
            graph_crores, graph_ten_crores, graph_hundred_crores,
            graph_thousand_crores, graph_ten_thousand_crores,
            graph_lakh_crores, graph_ten_lakh_crores,
        )
