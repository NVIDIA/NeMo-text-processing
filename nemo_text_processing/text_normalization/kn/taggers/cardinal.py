...
from nemo_text_processing.text_normalization.kn.graph_utils import ( NEMO_ALL_DIGIT,
    NEMO_ALL_ZERO,
    GraphFst,
    insert_space,
) 
...
class CardinalFst(GraphFst): 
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False): 
        ...
        #thousand = pynini.string_file(get_abs_path("data/numbers/thousand.tsv"))
        ...
        suffix_arabs = pynutil.insert(" ಅರಬ್")
        ...
        suffix_kharabs = pynutil.insert(" ಖರಬ್")
        ...
        suffix_nils = pynutil.insert(" ನೀಲ")
        ...
        suffix_padmas = pynutil.insert(" ಪದ್ಮ")
        ...
        suffix_shankhs = pynutil.insert(" ಶಂಖ")
        ...
        # e.g., English/arabic "073" -> "ಸೊನ್ನೆ ಏಳು ಮೂರು", Hindi/devnagri "००५" -> "ಸೊನ್ನೆ ಸೊನ್ನೆ ಐದು"
