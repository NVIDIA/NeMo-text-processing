...
# from nemo_text_processing.text_normalization.kn.taggers.serial import SerialFst
...
# from nemo_text_processing.text_normalization.kn.taggers.whitelist import WhiteListFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            # Simplified graph using only cardinal (no punct support yet)
            ...
            #graph = pynini.union(graph, punct)  # uncomment when PunctuationFst is ready
