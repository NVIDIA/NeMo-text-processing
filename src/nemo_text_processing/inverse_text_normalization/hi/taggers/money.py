...
class MoneyFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, decimal: GraphFst):
        ...
        graph_saade_teens_ties = (
            ...
            + pynutil.insert("\"")
            + delete_space
            + pynutil.insert(" fractional_part: \"५०\"")
            + delete_extra_space
            + self.currency
        )
        ...
        graph_saade_lakh = pynutil.add_weight(
            pynutil.delete("साढ़े")
            + delete_space
            + self.integer_quarterly_measures
            + delete_space
            + pynutil.insert("५००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_lakh
            + delete_extra_space
        ...
        graph_sava_lakh = pynutil.add_weight(
            pynutil.delete("सवा")
            + delete_space
            + self.integer_quarterly_measures
            + delete_space
            + pynutil.insert("२५०००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_lakh
            + delete_extra_space
        ...
        graph_paune_lakh = (
            ...
            + self.integer_paune
            + delete_space
            + pynutil.insert("७५०००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_lakh
            + delete_extra_space
        ...
        graph_dedh_lakh = (
            ...
            + pynutil.insert("१५००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_lakh
            + delete_extra_space
        ...
        graph_dhaai_lakh = (
            ...
            + delete_space
            + pynutil.insert("integer_part: \"")
            + pynutil.insert("२५००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_lakh
            + delete_extra_space
        ...
        graph_exceptions_lakhs = (
            graph_saade_lakh | graph_sava_lakh | graph_paune_lakh | graph_dedh_lakh | graph_dhaai_lakh
        )
        ...
        graph_saade_crore = (
            ...
            + self.integer_quarterly_measures
            + delete_space
            + pynutil.insert("५००००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_crore
            + delete_extra_space
        ...
        graph_sava_crore = (
            ...
            + self.integer_quarterly_measures
            + delete_space
            + pynutil.insert("२५०००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_crore
            + delete_extra_space
        ...
        graph_paune_crore = (
            ...
            + self.integer_paune
            + delete_space
            + pynutil.insert("७५०००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_crore
            + delete_extra_space
        ...
        graph_dhaai_crore = (
            ...
            + delete_space
            + pynutil.insert("integer_part: \"")
            + pynutil.insert("२५००००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_crore
            + delete_extra_space
        ...
        graph_dedh_crore = (
            ...
            + delete_space
            + pynutil.insert("integer_part: \"")
            + pynutil.insert("१५००००००", weight=-0.1)
            + pynutil.insert("\"")
            + delete_space
            + delete_crore
            + delete_extra_space
        ...
        graph_exceptions_crores = (
            graph_saade_crore | graph_sava_crore | graph_paune_crore | graph_dedh_crore | graph_dhaai_crore
        )

        graph_quarterly_measures = (
            graph_exceptions_teens_ties | graph_exceptions | graph_exceptions_lakhs | graph_exceptions_crores
        )
